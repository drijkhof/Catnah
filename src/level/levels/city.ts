...
const ROWS: string[] = [
  ...
  '.'.repeat(16) + 'oo' + '.'.repeat(32) + 'R'.repeat(6) + 'N' + 'S' + 'N' + 'o',
  ...
  '.'.repeat(6) + 'R'.repeat(6) + 'T' + '..' + 'R'.repeat(6) + '.'.repeat(4) + 'T' + 'R'.repeat(6) + '...' + 'oo' + '.'.repeat(13) + 'R'.repeat(6) + '...' + 'T' + 'R'.repeat(6),
  '.'.repeat(6) + 'R'.repeat(6) + 'T' + '..' + 'R'.repeat(6) + '.'.repeat(4) + 'T' + 'R'.repeat(6) + '.' + '===' + '.' + '===' + '.'.repeat(10) + 'R'.repeat(6) + '...' + 'T' + 'R'.repeat(6),
  '.'.repeat(6) + 'R'.repeat(6) + 'T' + '..' + 'R'.repeat(6) + '.'.repeat(4) + 'T' + 'R'.repeat(6) + '.'.repeat(18) + 'R'.repeat(6) + '...' + 'T' + 'R'.repeat(6),
  '.'.repeat(6) + 'R'.repeat(6) + 'T' + '..' + 'R'.repeat(6) + '.'.repeat(4) + 'T' + 'R'.repeat(6) + '.'.repeat(18) + 'R'.repeat(6) + '...' + 'T' + 'R'.repeat(6),
  '..' + 'P' + '...' + 'R'.repeat(6) + 'T' + 'h' + '.' + 'R'.repeat(6) + '..' + 'h' + '.' + 'T' + 'R'.repeat(6) + '..' + 'B'.repeat(6) + '.'.repeat(8) + 'h' + '.' + 'R'.repeat(6) + '...' + 'T' + 'R'.repeat(6) + '..' + 'E',
