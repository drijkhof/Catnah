...
const ROWS: string[] = [
  ...
  '.'.repeat(10) + 'T' + '.'.repeat(7) + 'o' + '.' + 'o' + '.'.repeat(9) + 'T' + '.'.repeat(7) + 'ooo' + '...' + 'T' + '.'.repeat(7) + 'R'.repeat(6) + 'T' + '.'.repeat(6) + 'RR' + '...' + 'RR' + '.'.repeat(10) + 'T',
  '.'.repeat(10) + 'T' + '.'.repeat(6) + 'R'.repeat(6) + '.' + 'B'.repeat(6) + 'T' + '.'.repeat(6) + 'R'.repeat(6) + '.' + 'T' + '.'.repeat(7) + 'R'.repeat(6) + 'T' + '.'.repeat(11) + 'RR' + '.'.repeat(10) + 'T',
  '...' + 'P' + '.'.repeat(6) + 'T' + '...' + 'h' + '..' + 'R'.repeat(6) + '.'.repeat(7) + 'T' + '...' + 'h' + '..' + 'R'.repeat(6) + '.' + 'T' + '.'.repeat(7) + 'R'.repeat(6) + 'T' + '.'.repeat(4) + 'h' + '.'.repeat(6) + 'RR' + '.'.repeat(10) + 'T' + '.'.repeat(5) + 'E',
