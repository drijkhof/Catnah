...
const LEVEL_SOURCE: string[] = [
  ...
  '.'.repeat(30) + 'T' + '.'.repeat(29) + 'oo' + '.'.repeat(4) + 'oo' + '.'.repeat(5) + 'T',
  '.'.repeat(30) + 'T' + 'ooo' + '.'.repeat(26) + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T',
  '.'.repeat(30) + 'T' + '='.repeat(5) + '.'.repeat(24) + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T',
  '.'.repeat(10) + 'T' + '.'.repeat(15) + 'ooo' + '.' + 'T' + '.'.repeat(13) + 'T' + '.'.repeat(15) + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T' + 'ooo',
  '.'.repeat(10) + 'T' + 'ooo' + '.'.repeat(12) + '='.repeat(4) + 'T' + '.'.repeat(13) + 'T' + 'ooo' + '.'.repeat(12) + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T' + '='.repeat(5),
  '.'.repeat(10) + 'T' + '='.repeat(5) + '.'.repeat(14) + 'T' + '.'.repeat(13) + 'T' + '='.repeat(4) + '.'.repeat(11) + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T',
  '.'.repeat(6) + 'ooo' + '.' + 'T' + '.'.repeat(19) + 'T' + '.'.repeat(9) + 'ooo' + '.' + 'T' + '.'.repeat(15) + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T',
  '.'.repeat(6) + '='.repeat(4) + 'T' + '.'.repeat(19) + 'T' + '.'.repeat(9) + '='.repeat(4) + 'T' + '.'.repeat(8) + 'ooo' + '.'.repeat(4) + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T',
  '.'.repeat(10) + 'T' + '.'.repeat(5) + 'ooo' + '.'.repeat(11) + 'T' + '.'.repeat(4) + 'ooo' + '.'.repeat(6) + 'T' + '.'.repeat(7) + 'R'.repeat(6) + '..' + 'RR' + '.'.repeat(4) + 'RR' + '.'.repeat(5) + 'T',
  '.'.repeat(10) + 'T' + '.'.repeat(4) + 'R'.repeat(6) + '.' + 'B'.repeat(6) + '..' + 'T' + '...' + 'R'.repeat(6) + '.'.repeat(4) + 'T' + '.'.repeat(7) + 'R'.repeat(6) + '.'.repeat(8) + 'RR' + '.'.repeat(5) + 'T',
  '...' + 'P' + '.'.repeat(6) + 'T' + '.'.repeat(4) + 'R'.repeat(6) + '.'.repeat(9) + 'T' + '...' + 'R'.repeat(6) + '.'.repeat(4) + 'T' + '.'.repeat(7) + 'R'.repeat(6) + '.'.repeat(8) + 'RR' + '.'.repeat(5) + 'T',
